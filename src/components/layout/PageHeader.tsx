...
/**
 * Cabeçalho padronizado para páginas internas (listagens, formulários, sobre).
 * Mantém identidade do gradiente hero em versão mais discreta e ritmo vertical consistente.
 */
export function PageHeader({ eyebrow, title, description, actions, compact }: Props) {
  return (
