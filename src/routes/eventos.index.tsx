  ...
  head: () => ({
    meta: [
      ...
      },
      {
        name: "description",
        content:
          "Explore cursos, congressos, workshops e jornadas científicas de nutrição em todo o Brasil.",
      },
      {
        property: "og:title",
        content: "Eventos de nutrição — ICN Hub",
      },
      {
        property: "og:description",
        content:
          "Cursos, congressos e workshops filtrados por área, modalidade e valor.",
      },
    ],
  }),
      ...
      <section className="mx-auto max-w-7xl px-4 py-8 sm:px-6 md:py-10">
        ...
        {isLoading ? (
          ...
          <div className="mt-8 rounded-2xl border border-dashed border-border bg-card p-12 text-center">
            ...
            <p className="mt-2 text-sm text-muted-foreground">
              Ajuste os filtros ou limpe a busca para
              ver mais resultados.
            </p>
          </div>
        ) : (
