  ...
  head: () => ({
    meta: [
      ...
      },
      {
        name: "description",
        content:
          "Mentorias individuais e em grupo com nutricionistas de referência em todo o Brasil.",
      },
      {
        property: "og:title",
        content: "Mentorias em nutrição — ICN Hub",
      },
      {
